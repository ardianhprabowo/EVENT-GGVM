...
Public Class CetakExhibition
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CetakExhibition.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_material() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCetakExhibition
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakExhibition = New CetakExhibition()
        rpt.Site = Me.Site
        Return rpt
    End Function
