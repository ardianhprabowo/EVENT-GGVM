...
Public Class CrpPengajuanAll_Pic
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CrpPengajuanAll-Pic.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrpPengajuanAll-Pic.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_tampilIdMajuAll() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrpPengajuanAll_Pic
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpPengajuanAll_Pic = New CrpPengajuanAll_Pic()
        rpt.Site = Me.Site
        Return rpt
    End Function
