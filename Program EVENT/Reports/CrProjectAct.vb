...
Public Class CrProjectAct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrProjectAct.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_CrpBreakProjectrpt_idpe() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrProjectAct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrProjectAct = New CrProjectAct()
        rpt.Site = Me.Site
        Return rpt
    End Function
