...
Public Class CrpBreakProject
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrpBreakProject.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpBreakProject
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpBreakProject = New CrpBreakProject()
        rpt.Site = Me.Site
        Return rpt
    End Function
