...
Public Class BiayaEksekusi
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.BiayaEksekusi.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiayaEksekusi
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiayaEksekusi = New BiayaEksekusi()
        rpt.Site = Me.Site
        Return rpt
    End Function
