...
Public Class CetakPengajuan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CetakPengajuan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCetakPengajuan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakPengajuan = New CetakPengajuan()
        rpt.Site = Me.Site
        Return rpt
    End Function
