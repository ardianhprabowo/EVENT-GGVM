...
Public Class CrInstoreCoverAct
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrInstoreCoverAct.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrInstoreCoverAct
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrInstoreCoverAct = New CrInstoreCoverAct()
        rpt.Site = Me.Site
        Return rpt
    End Function
