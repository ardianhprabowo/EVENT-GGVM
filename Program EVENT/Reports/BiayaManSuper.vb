...
Public Class BiayaManSuper
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.BiayaManSuper.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBiayaManSuper
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BiayaManSuper = New BiayaManSuper()
        rpt.Site = Me.Site
        Return rpt
    End Function
