...
Public Class CrBreakdownSDM
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrBreakdownSDM.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrBreakdownSDM
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrBreakdownSDM = New CrBreakdownSDM()
        rpt.Site = Me.Site
        Return rpt
    End Function
