...
Public Class CrpPengajuanAll
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrpPengajuanAll.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_myidpengajuan() As CrystalDecisions.[Shared].IParameterField
        Get
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_idpengajuan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCrpPengajuanAll
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpPengajuanAll = New CrpPengajuanAll()
        rpt.Site = Me.Site
        Return rpt
    End Function
