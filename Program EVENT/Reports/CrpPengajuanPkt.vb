...
Public Class CrpPengajuanPkt
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CrpPengajuanPkt.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCrpPengajuanPkt
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CrpPengajuanPkt = New CrpPengajuanPkt()
        rpt.Site = Me.Site
        Return rpt
    End Function
