...
Public Class CetakPENestle
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Program_EVENT.CetakPENestle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_Jabatan() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedCetakPENestle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CetakPENestle = New CetakPENestle()
        rpt.Site = Me.Site
        Return rpt
    End Function
