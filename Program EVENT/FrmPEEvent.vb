...
#Region "Deklarasi Perintah"
    Private Sub TampilanAwal()
        ProsesInput.Caption = "Proses Input"
        BtnDelete.Caption = "Hapus PE"
    ...
    Private Sub SimpanTotal()
        ...
        Catch ex As Exception
            MsgBox("Data Gagal di Update", MsgBoxStyle.Critical, "Message !!")
        Finally
            GGVM_conn_close()
        End Try
    End Sub
    ...
    End Sub
    Private Sub DetailTampil()
        ProsesInput.Caption = "Tambah Detail"
        TampilDetail.Enabled = False
        EditPE.Enabled = True
    End Sub
    Private Sub DetailTambah()
        ProsesInput.Caption = "Tambah Detail"
...
#Region "Auto Complete"
    ...
    Private Sub SimpanDetail_ItemClick(sender As Object, e As ItemClickEventArgs) Handles SimpanDetail.ItemClick
    ...
    End Sub
#End Region
    Private Sub FrmPEEvent_Load(sender As Object, e As EventArgs) Handles Me.Load
    ...
    Private Sub BuatPE_ItemClick(sender As Object, e As DevExpress.XtraBars.ItemClickEventArgs) Handles BuatPE.ItemClick
        ...
        End Try
    End Sub
    Private Sub ProsesInput_ItemClick(sender As Object, e As ItemClickEventArgs) Handles ProsesInput.ItemClick
        If ProsesInput.Caption = "Proses Input" Then
            ...
            Else
                ...
                End If
            End If
            ControlListPE.SelectedTabPage = TabDetailPenawaran
            ProsesInput.Caption = "Tambah Detail"
        ElseIf ProsesInput.Caption = "Tambah Detail" Then
            ControlListPE.SelectedTabPage = TabDetailPenawaran
            If DivUser = "17" Then
                TDay.Visible = False
                CSDay.Visible = False
            ElseIf DivUser = "2" Or "0" Then
                TMaterials.Visible = False
                TDimensi.Visible = False
            Else
                Return
            ...
            If EditPE.Enabled = True Then
                BtnOKInput.Text = "Input"
            Else
                BtnOKInput.Text = "Tambah"
            End If
            PInput.Visible = True
            Call CompleteBarangPE()
            Call LoadSatuan()
            TCari.Select()
        ElseIf ProsesInput.Caption = "Deal" Then
            If TidPE.Text = "" Then
    ...
    Private Sub BtnDelete_ItemClick(sender As Object, e As ItemClickEventArgs) Handles BtnDelete.ItemClick
        If BtnDelete.Caption = "Hapus PE" Then
            Dim ada As Boolean
            ...
            Next I
            ListPE.EndUpdate()
        ElseIf BtnDelete.Caption = "Hapus Detail" Then
            ...
            TampilDetail.EndUpdate()
        Else
            MsgBox("Terjadi Kesalahan ! | Harap Hubungi Administrator")
        End If
    End Sub


    Private Sub EditPE_ItemClick(sender As Object, e As ItemClickEventArgs) Handles EditPE.ItemClick
        Try
            If TidPE.Text = "" Then
    ...
    Private Sub CetakTool_ItemClick(sender As Object, e As ItemClickEventArgs) Handles CetakTool.ItemClick
        ...
        With Me.ListPE
            ...
            For Each subItem As ListViewItem.ListViewSubItem In ListPE.Items(i).SubItems
                Dim myString As String = ListPE.Items(i).SubItems(innercounter).Text
    ...
    Private Sub ListPE_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ListPE.SelectedIndexChanged
        With Me.ListPE
            ...
            BtnKeluar.Caption = "Batal"
            CetakTool.Enabled = True
            ProsesInput.Caption = "Deal"
            If StatusBarang = "Belum Ada Barang" Then
                If ProsesInput.Caption = "Tambah Detail" Then
                    ProsesInput.Enabled = True
                    SimpanDetail.Enabled = True
                    ProsesDetail = "Tambah"
                End If
    ...
    Private Sub TampilDetail_SelectedIndexChanged(sender As Object, e As EventArgs) Handles TampilDetail.SelectedIndexChanged
        PInput.Visible = True
        BtnOKInput.Text = "Edit"
        With Me.TampilDetail
            Dim i As Integer
            For Each item As ListViewItem In TampilDetail.SelectedItems
                i = item.Index
            Next
            BtnDelete.Caption = "Hapus Detail"
            Dim innercounter As Integer = 0
    ...
    Private Sub CKontrak_EditValueChanged(sender As Object, e As EventArgs) Handles CKontrak.EditValueChanged
        ...
        End Try
    End Sub
    Private Sub PanelAlasan_MouseMove(sender As Object, e As MouseEventArgs) Handles PanelAlasan.MouseMove
        If (Panel1Captured) Then PanelAlasan.Location = PanelAlasan.Location + e.Location - Panel1Grabbed
    End Sub

    Private Sub PanelAlasan_MouseDown(sender As Object, e As MouseEventArgs) Handles PanelAlasan.MouseDown
        Panel1Captured = True
        Panel1Grabbed = e.Location
    End Sub
    Private Sub PanelAlasan_MouseUp(sender As Object, e As MouseEventArgs) Handles PanelAlasan.MouseUp
        Panel1Captured = False
    End Sub
    ...
    Private Sub BtnTutup_Click(sender As Object, e As EventArgs) Handles BtnTutup.Click
        ...
        ClearDetail()
    End Sub
    Private Sub BtnOKInput_Click(sender As Object, e As EventArgs) Handles BtnOKInput.Click
        Dim c As String
        ...
        Else
            ...
            If BtnOKInput.Text = "Input" Then
                ...
                Call CompleteBarangPE()
                GGVM_conn_close()
            ElseIf BtnOKInput.Text = "Tambah" Then
                sql = ""
                sql = sql & "insert into evn_detail_penawaran (idpe, "
                If idKontrak.Text <> "" Then
                    sql = sql & "item, material_no, "
                ...
                Call CompleteBarangPE()
                GGVM_conn_close()
            ElseIf BtnOKInput.Text = "Edit" Then
                sql = ""
    ...
    Private Sub BtnKeluar_ItemClick(sender As Object, e As ItemClickEventArgs) Handles BtnKeluar.ItemClick
        If BtnKeluar.Caption = "Keluar" Then
            Close()
        ElseIf BtnKeluar.Caption = "Batal" Then
            TampilanAwal()
            BuatPE.Enabled = True
            ListPE.Enabled = True
            TampilDetail.Enabled = False
